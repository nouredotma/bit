<template>
    <div class="max-w-2xl mx-auto">
        <form v-if="!success" @submit.prevent="submitForm" class="space-y-6">
            <div>
                <label class="block text-xs font-bold uppercase tracking-widest text-gray-400 mb-2 ml-1">Your Name</label>
            ...
            <div>
                <label class="block text-xs font-bold uppercase tracking-widest text-gray-400 mb-2 ml-1">Message</label>
        ...
        <div v-else class="text-center py-20">
            ...
            <h3 class="text-2xl font-bold tracking-tighter uppercase mb-2">Message Sent!</h3>
            <p class="text-gray-400 text-sm mb-8">We'll get back to you as soon as possible.</p>
            <a href="/" class="bg-black text-white px-8 py-4 rounded-xl uppercase tracking-widest text-xs font-bold hover:bg-gray-800 transition-colors inline-block">Back to Home</a>
        </div>
    </div>
</template>
